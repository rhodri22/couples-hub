...
export const getShopCat   = id => SHOP_CATEGORIES.find(c => c.id === id) || SHOP_CATEGORIES[7]
...
export const DEMO_SHOPPING = [
  { id: genId(), item: 'Milk', qty: '2 pints', category: 'dairy', checked: false, added_by: 'becky', created_at: new Date().toISOString() },
  { id: genId(), item: 'Dog food', qty: '1 bag', category: 'pet', checked: false, added_by: 'rhodri', created_at: new Date().toISOString() },
  { id: genId(), item: 'Bananas', qty: '', category: 'produce', checked: true, added_by: 'rhodri', created_at: new Date().toISOString() },
]
...
export const DEMO_SETTINGS = { away: [] }
...
export const BADGES = [
  ...
  { id: 'fair',        emoji: '⚖️', label: 'Fair Share',    desc: 'A balanced week between you both' },
